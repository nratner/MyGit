...
def make_soup(hand):
    ...
    return soupdata
soup = make_soup
for record in soup.findAll(text="Equipment ID:"):
    print record.findNext('td').text
#     for data in record.find('p'):
#         print data.text

#     for tag in line:
#         equipid = line.find(text="Equipment ID:").findNext('td')
#         location = line.find(text="Location:").findNext('td')
#         inspector = line.find(text="Inspector:").findNext('td')
#         comments = line.find(text="Comments:").findNext('td')
